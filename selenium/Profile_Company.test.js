...
describe('profile page', () => {
  ...
  it('shows the company information', async () => {
    ...
    expect(await companyInformation.findElement(By.css('h3')).getText()).toEqual('Company Information');
  });
  ...
  it('allows adding and saving equipment', async () => {
    ...
    let equipmentList = await driver.wait(until.elementLocated(By.id('formFlashEquipmentList')));
